			...
			<form action="<?php echo U();?>" method="post" class="form-horizontal">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						...
						<div class="controls">
							<label class="item-label">								
								<input type="text" name="listorder" class="text input-large" value="<?php echo ((isset($info["listorder"]) && ($info["listorder"] !== ""))?($info["listorder"]):''); ?>">
							</label>
						</div>
					</div>
					<div class="controls">
						...
						<input type="hidden" name="picurl" id="icon" value="<?php echo ((isset($info['picurl']) && ($info['picurl'] !== ""))?($info['picurl']):''); ?>"/>
						<div class="upload-img-box">
						<?php if(!empty($info['picurl'])): ?><div class="upload-pre-item"><img src="<?php echo (get_cover($info["picurl"],'path')); ?>"/></div><?php endif; ?>
						</div>
					</div>
