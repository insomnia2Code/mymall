...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('add',array('product_id'=>I('get.product_id',0)));?>">新 增</a>
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/mymall/admin.php?s=/GoodsAttr/lists/product_id/1.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a title="编辑属性" href="<?php echo U('Admin/GoodsAttr/attrlist?attr_id='.$attr['id']);?>">属性列表</a>
